...
> 예: "거래 내역 정렬 기능 추가 및 Table 컴포넌트 개선"
...
- 정렬 기능 추가 (createdAt 기준, 최신 순)
- `BasePaginationInput`에 정렬 필드 통합
- `Table` 컴포넌트를 column 기반 렌더링 방식으로 변경
...
> 관련된 이슈 번호가 있다면 연결해주세요 (자동 닫힘 처리 가능)
